...
const UserProfile = (props: UserProfileProps) => {
  ...
  const [passwdMatch, setPasswdMatch] = useState<boolean>(false);
  const [profileViewCollapse, setProfileViewCollapse] = useState<boolean>(
    false
  );
  const [movieTypeViewCollapse, setMovieTypeViewCollapse] = useState<boolean>(
    false
  );
  ...
  useEffect(() => {
    ...
    user && name ? (setUser(user), setUsername(name)) : null;
  }, []);
  ...
  const onNewPasswdChange = (text: string) => {
    setNewPasswd(text);
  };

  const onNewPasswdConfirmChange = (text: string) => {
    setNewPasswd(text);

    newPasswd === newPasswd ? setPasswdMatch(true) : null;
  };
      ...
      {user && user.displayName && user.email ? (
        ...
        >
          ...
          <View style={{ marginTop: 20, display: "flex" }}>
            ...
            >
              <View style={{ flexDirection: "row", alignItems: "center" }}>
                <FontAwesome5Icon name="user" size={24} color={colors.white} />
                <Text
                  style={{
                    fontSize: 24,
                    color: colors.white,
            ...
            <View
              style={{
                display: profileViewCollapse ? "flex" : "none",
              }}
            >
              <View>
              ...
              <TouchableOpacity
                style={styles.button}
                onPress={() => OnSubmitProfileChanges()}
              >
          ...
          <View style={{ marginTop: 20, display: "flex" }}>
            ...
            >
              <View style={{ flexDirection: "row", alignItems: "center" }}>
                <FontAwesome5Icon name="film" size={24} color={colors.white} />
                <Text
                  style={{
                    fontSize: 24,
                    color: colors.white,
            ...
            >
              <SettingsMovieTypeCountButtonRow navigation={props.navigation} />
            </View>
          </View>
          ...
          <View style={{ marginTop: 20, display: "flex" }}>
            ...
            <View
              style={{
                display: statsViewCollapse ? "flex" : "none",
              }}
            >
